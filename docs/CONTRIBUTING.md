![Android CI](https://github.com/godot-mobile-plugins/godot-firebase/actions/workflows/android-ci.yml/badge.svg)
![iOS CI](https://github.com/godot-mobile-plugins/godot-firebase/actions/workflows/ios-ci.yml/badge.svg)

# <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="28"> Contributing
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Table of Contents
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Project structure
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Build System Architecture
...
println(pluginConfig.pluginName)        // "FirebasePlugin"
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Prerequisites
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Common Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Build Customization
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Local Configuration
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> iOS Configuration
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Development Workflow
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Building
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Cross-Platform Builds
...
- **Release archive:** `release/FirebasePlugin-*-v*.zip`

---

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Android Builds
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> iOS Builds
...
- **Plugin XCFrameworks:** `ios/build/framework/FirebasePlugin.debug.xcframework`, `FirebasePlugin.release.xcframework`
- **Release archive:** `release/FirebasePlugin-iOS-v*.zip`
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Testing
...
|------|----------|---------|
| `FirebaseTests.swift` | Swift | `Firebase` class — init, `isActiveKey`, `onThisHappened` callback, ObjC bridging, concurrency |
| `FirebaseLoggerTests.mm` | Objective-C++ | `firebase_log` global — initialization, all log levels, format string handling |

The tests are compiled into the `firebase_plugin_tests` Xcode test bundle target, which declares a dependency on the main `firebase_plugin` static library target. The Xcode scheme used by the build system is `firebase_plugin_tests`.
...
| Concern | Detail |
|---------|--------|
| Target name | `firebase_plugin_tests` |
| Product type | `com.apple.product-type.bundle.unit-test` |
| Scheme file | `ios/plugin.xcodeproj/xcshareddata/xcschemes/firebase_plugin_tests.xcscheme` |
| Linked library | `libfirebase_plugin.a` (the main plugin target) |
| Target dependency | `firebase_plugin` (built before tests run) |
| Header search paths | `$(SRCROOT)/src`, `$(CONFIGURATION_TEMP_DIR)/firebase_plugin.build/DerivedSources` |

#### Writing new iOS tests

Swift tests: add a new `XCTestCase` subclass to `ios/test/unit/` and register the file in the `firebase_plugin_tests` target's Sources build phase in `project.pbxproj`.

Objective-C++ tests: add a `.mm` file to `ios/test/unit/`. Import `firebase_logger.h` for logger access or `firebase_plugin.h` for the plugin class. Add the file to the Sources build phase the same way.

> **Note on Godot engine classes:** `FirebasePlugin` (the `Object` subclass), `firebase_plugin_init()`, and `firebase_plugin_deinit()` all depend on `memnew`/`memdelete` and `Engine::get_singleton()`, which are Godot engine internals unavailable in a plain XCTest host. Test those paths using GDScript integration tests via the Godot editor or the [GUT](https://github.com/bitwes/Gut) framework instead.
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Creating Releases
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> GitHub Actions Workflows
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Installation

### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Installing to Demo App
...
### <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="20"> Installing to Your Project
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Troubleshooting
...
#   ios/plugin.xcodeproj/xcshareddata/xcschemes/firebase_plugin_tests.xcscheme
# and the test target must be listed in the targets array of project.pbxproj.
# Verify both are present:
find ios/plugin.xcodeproj -name "firebase_plugin_tests.xcscheme"
grep "firebase_plugin_tests" ios/plugin.xcodeproj/project.pbxproj
```

**Problem:** iOS tests fail with "module not found" or linker errors
```bash
# The test target links against libfirebase_plugin.a.
...
```bash
# Tests that exercise FirebasePlugin (the Godot Object subclass) or the
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Contributing Guidelines
...
## <img src="https://raw.githubusercontent.com/godot-mobile-plugins/godot-firebase/main/addon/src/main/icon.png" width="24"> Additional Resources
